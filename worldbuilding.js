...
function setupWorldbuildingIntro() {
    ...
    gsap.delayedCall(0.2, () => {
        gsap.to(".side-scroller-wrap, .slot-label, .category-nav, .worldbuilding-title, .character-description, .character-gallery .gallery-item", {
            opacity: 1,
            duration: 0.6,
            ease: "power2.out"
        });
